...
1. `.eds-pager__button-next`（蝦皮 EDS Pager 按鈕核心 Class）
2. `[class*="pager"] [class*="next"]`
3. `.eds-pagination__next button`, `.eds-pagination__next`
4. `[class*="pagination"] [class*="next"] button`
5. `button[class*="next"]`, `a[class*="next"]`
6. `li.next a`, `li.next button`, `.ant-pagination-next`
